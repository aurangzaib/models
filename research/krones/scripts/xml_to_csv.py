...
Usage (from models/research/):
  ...
  # Create train data:
  python dataset_krones_2/scripts/xml_to_csv.py --xml_dir=${krones_train_annotations} --csv=${krones_train_csv}

  # Create test data:
  python dataset_krones_2/scripts/xml_to_csv.py --xml_dir=${krones_eval_annotations} --csv=${krones_eval_csv}
"""
